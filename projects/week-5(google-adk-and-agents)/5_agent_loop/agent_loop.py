...
# Point ADK at Vertex AI, matching Day 1: the orchestrator, css_agent and qa_agent
# all inherit this and reach Gemini through Vertex using Application Default
# Credentials (`gcloud auth application-default login`). "global" is a safe default.
