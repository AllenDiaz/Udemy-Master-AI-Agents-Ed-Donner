...
# Vertex AI serves an OpenAI-compatible endpoint, so OpenAIChatClient works against
# it once we hand it Vertex's base URL and a fresh ADC OAuth token as the api_key.
# The Vertex endpoint expects model ids prefixed with "google/".
client = OpenAIChatClient(
    model=vertex_client.resolve_model(MODEL),
