...
MODEL_ID = os.environ.get("WORKER_MODEL", vertex_client.DEFAULT_MODEL)
# Vertex AI serves an OpenAI-compatible endpoint, so Pydantic AI's OpenAIChatModel
# works against it once we hand it a provider with Vertex's base URL and a fresh
# ADC OAuth token as the API key. The model id gets a "google/" prefix.
MODEL = OpenAIChatModel(
    vertex_client.resolve_model(MODEL_ID),
