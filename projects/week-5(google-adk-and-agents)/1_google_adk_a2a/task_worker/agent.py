...
# ADK talks to Gemini natively. Point it at Vertex AI (using Application Default
# Credentials from `gcloud auth application-default login`) instead of the public
# Gemini API. Region + project come from the env; "global" is a good default.
